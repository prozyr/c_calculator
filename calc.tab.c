...
#line 1 "calc.y"
    ...
    #include "lex.yy.h"  // Include lex.yy.h to get declarations

    extern double atof(const char *nptr);
    extern int yylex();
    extern char *yytext;  // Declare yytext

    // Add a declaration for yyerror
